...
namespace FunctionIdentityUserAccess
{
    public class AzureADJwtBearerValidation
    {
        ...
        public AzureADJwtBearerValidation(IConfiguration configuration, ILoggerFactory loggerFactory)
        {
            ...
            _tenantId = _configuration["AzureFunctionsJobHost:AzureAd:TenantId"];
            _audience = _configuration["AzureFunctionsJobHost:AzureAd:ClientId"];
            _instance = _configuration["AzureFunctionsJobHost:AzureAd:Instance"];
